...
use OpenAgenda\Database\Helpers\Config;
use OpenAgenda\Database;
...
class Relation {
     ...
     * @throws DatabaseException First you must define tables name
     */
    protected function setKey($type, $key)
    {
        ...
        throw new DatabaseException('First you must define tables name');
    }
     ...
     * @throws DatabaseException Tables names or keys missing
     */
    public function setRelation()
    {
        ...
        {
            throw new DatabaseException('Tables names or keys missing');
        }
    }
