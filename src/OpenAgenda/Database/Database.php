...
use OpenAgenda\Database\Helpers;

/**
 * Core class of Database.
 *
 ...
 * @link https://github.com/Greg0/Database-Database GitHub Repository
 */
class Database implements \IteratorAggregate, \Countable {
     ...
     * @see \Database\Classes\Core_Database::setPending()
     * @var array
     */
    protected $pending;
     ...
     * @return OpenAgenda\Database\Database
     * @throws DatabaseException If there's problems with load file
     */
     ...
     * @throws DatabaseException If there's no data with that ID
     */
    protected function getRowKey($id)
    {
        ...
        throw new DatabaseException('No data found with ID: ' . $id);
    }
    ...
    public function __get($name)
    {
        ...
        throw new DatabaseException('There is no data');
    }
     ...
     * @throws DatabaseException If table exist
     */
    public static function create($name, array $fields)
    {
        ...
        {
            throw new DatabaseException('helper\Table "' . $name . '" already exists');
        }
     ...
     * @param string $name Table name
     * @return boolean|DatabaseException
     */
